				...
				<div class="container">
					<div id="search_keyword">
			            <form action="#" method="get">
			              <input type="text" name="keyword" value="" id="input_keyword" placeholder="Enter a keyword" class="txt_field" style="width: 90%;
	height: 100px;font-size:50px">
						  <input type="image" src="./resources/images/link-ico.png" alt="Search" id="search_button" style="display: inline-block;
			            ...
			            <div id="board_summary" class="cell">
			            	...
			            	<div class="board-grids">
				            	<table>
									...
									<c:forEach begin="1" end="5" var="board" items="${boards}">
									<tr>
										<td>
