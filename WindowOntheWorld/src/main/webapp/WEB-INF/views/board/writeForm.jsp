...
<div class="row">
    ...
    <div class="col-md-8">
        <h2 class="text-center">글쓰기</h2><p></p>
    	...
    	<form id="writeform" action="write"  method="post" enctype="multipart/form-data" onsubmit="return formCheck();">
            ...
            <tr>
                <td>글 내용</td>
                <td><textarea rows="10" cols="50" name="content" id="content" class="form-control" placeholder="글 내용"></textarea></td>
            </tr>
            ...
            <tr>  
                <td colspan="2"  class="text-center">
                    ...
                    <button type="submit" class="btn btn-info btn-lg">
       				<span class="glyphicon glyphicon-pencil btn-info"></span> 글쓰기
     				</button>
