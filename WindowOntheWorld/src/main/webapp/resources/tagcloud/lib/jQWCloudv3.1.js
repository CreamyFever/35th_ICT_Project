...
Util.getRandomColor = function(){
	...
	var letter1 = '012345'.split('');
	var letter2 = '56789A'.split('');
	var letter3 = 'ABCDEF'.split('');
	
    var color = '#';
    
    color += letter1[Math.round(Math.random() * 5)];
    color += letters[Math.round(Math.random() * 15)];
    color += letter2[Math.round(Math.random() * 5)];
    color += letters[Math.round(Math.random() * 15)];
    color += letter3[Math.round(Math.random() * 5)];
    color += letters[Math.round(Math.random() * 15)];
